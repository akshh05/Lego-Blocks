 ...
 * Wed Apr 17 2024 17:34:48 GMT+0530 (India Standard Time)
...
var dictwhi, x, dictblue, dictred, clonewhi, cloneblue, clonered;
...
function drag3(x) {
  registerOnClick(x, false, false, [0,1,2], function() {
    registerOnDrag(x, false, [0,1,2], function() {}, function() {
      dragMove(x, 'XYZ', ';x.^9!YzgY_2VAh]96i5', 'CkD:-a8,@Q{cE:!E[E8J');
    }, function() {
      dictSet(dictwhi, x, getObjTransform(x, false, 'position', 'xyz'));
      console.log(dictwhi);
    }, 'CkD:-a8,@Q{cE:!E[E8J');
  }, function() {});
}
...
function drag4(x) {
  registerOnClick(x, false, false, [0,1,2], function() {
    registerOnDrag(x, false, [0,1,2], function() {}, function() {
      dragMove(x, 'XYZ', 'E[46Q}/1TVB11,CFMkS3', 'j*BpGBbAFh;U9%V}^*$A');
    }, function() {
      dictSet(dictblue, x, getObjTransform(x, false, 'position', 'xyz'));
      console.log(dictblue);
    }, 'j*BpGBbAFh;U9%V}^*$A');
  }, function() {});
}
...
function drag5(x) {
  registerOnClick(x, false, false, [0,1,2], function() {
    registerOnDrag(x, false, [0,1,2], function() {}, function() {
      dragMove(x, 'XYZ', 'v?{jP5B+v%r=hc*Z|hts', '*}OF%ymB^X$#dGVqEVcW');
    }, function() {
      dictSet(dictred, x, getObjTransform(x, false, 'position', 'xyz'));
      console.log(dictred);
    }, '*}OF%ymB^X$#dGVqEVcW');
  }, function() {});
}
...
changeVis('Block.001', false);
addHTMLElement('button', 'white', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'white', 'white', false);
setHTMLElemStyle('height', '50px', 'white', false);
setHTMLElemStyle('width', '50px', 'white', false);
...
eventHTMLElem('click', 'white', false, function(event) {
  changeVis('Block.001', true);
});
registerOnDrag('Block.001', false, [0,1,2], function() {}, function() {
  dragMove('Block.001', 'XYZ', 'CvTiKZbkKr++ryiJr`6]', 'n`:bJ^L$^E62GR:ZT,d@');
}, function() {}, 'n`:bJ^L$^E62GR:ZT,d@');

dictwhi = {};
eventHTMLElem('dblclick', 'white', false, function(event) {
  clonewhi = cloneObject('Block.001');
  setObjTransform(clonewhi, false, 'position', [-13, -17, 0.75], false);
  changeVis(clonewhi, true);
  drag3(clonewhi);
});
...
setHTMLElemStyle('height', '50px', 'blue', false);
setHTMLElemStyle('width', '50px', 'blue', false);
setHTMLElemStyle('display', 'block', 'blue', false);
setHTMLElemStyle('marginRight', '0 auto', 'blue', false);
setHTMLElemStyle('alignSelf', 'flex-start', 'blue', false);
eventHTMLElem('click', 'blue', false, function(event) {
  changeVis('Block2', true);
});
registerOnDrag('Block2', false, [0,1,2], function() {}, function() {
  dragMove('Block2', 'XYZ', 'kf0i{D^[^GV]X_CqY-^B', '.2YzpO=.:1OGjgvTw};3');
}, function() {}, '.2YzpO=.:1OGjgvTw};3');

dictblue = {};
eventHTMLElem('dblclick', 'blue', false, function(event) {
  cloneblue = cloneObject('Block2');
  setObjTransform(cloneblue, false, 'position', [-13, -17, 0.75], false);
  changeVis(cloneblue, true);
  drag4(cloneblue);
});

changeVis('Block3.001', false);
addHTMLElement('button', 'red', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'red', 'red', false);
setHTMLElemStyle('height', '50px', 'red', false);
...
setHTMLElemStyle('width', '50px', 'red', false);
eventHTMLElem('click', 'red', false, function(event) {
  changeVis('Block3.001', true);
});
registerOnDrag('Block3.001', false, [0,1,2], function() {}, function() {
  dragMove('Block3.001', 'XYZ', '4Ie_L-@peQ)!6?Z#S].|', '64+Sd96/?;2:hJBuXR`7');
}, function() {}, '64+Sd96/?;2:hJBuXR`7');

dictred = {};
eventHTMLElem('dblclick', 'red', false, function(event) {
  clonered = cloneObject('Block3.001');
  setObjTransform(clonered, false, 'position', [-13, -17, 0.75], false);
