 ...
 * Tue Apr 16 2024 18:49:44 GMT+0530 (India Standard Time)
...
function drag3() {
  registerOnClick(i, false, false, [0,1,2], function() {
    registerOnDrag(i, false, [0,1,2], function() {}, function() {
      dragMove(i, 'XYZ', 'P?o|Pz[t!(XJ!5c=DSbT', 'q]8n!/p[PNf2%-8G/BU#');
    }, function() {
      dictSet(sd, i, getObjTransform(i, false, 'position', 'xyz'));
      console.log(sd);
    }, 'q]8n!/p[PNf2%-8G/BU#');
  }, function() {});
}
...
eventHTMLElem('click', 'red', false, function(event) {
  setObjTransform(cloneObject('Block3.001'), false, 'position', [7.2, -1, i], false);
  changeVis('Block3.001', true);
  i = (typeof i == 'number' ? i : 0) + 1.8;
});
registerOnDrag('Block3.001', false, [0,1,2], function() {}, function() {
  dragRotate('Block3.001', 'Y', true, 'epzyN:^Oyd.xIuKE2CYv', 'EE{:r0N.VA1j1g`2X{k)');
}, function() {}, 'EE{:r0N.VA1j1g`2X{k)');

sd = {};

eventHTMLElem('dblclick', 'white', false, function(event) {
  cd = cloneObject('Block.001');
  setObjTransform('<none>', false, 'position', [8.2, -1, 15], false);
  changeVis(cd, true);
  drag3();
});
...
setHTMLElemStyle('height', '30px', 'blue', false);
setHTMLElemStyle('width', '30px', 'blue', false);
...
eventHTMLElem('click', 'blue', false, function(event) {
  setObjTransform(cloneObject('Block2'), false, 'position', [8.2, -1, i], false);
  changeVis('Block2', true);
  i = (typeof i == 'number' ? i : 0) + 1.8;
});
registerOnDrag('Block2', false, [0,1,2], function() {}, function() {
  dragRotate('Block2', 'Y', true, 'Dh*h)xY_o.F45NkfF-ZA', 'vi$2F0@EfN`U3N?kbA4i');
}, function() {}, 'vi$2F0@EfN`U3N?kbA4i');

addHTMLElement('button', 'clear', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'clear', 'clear', false);
setHTMLElemStyle('height', '30px', 'clear', false);
setHTMLElemStyle('width', '30px', 'clear', false);
eventHTMLElem('click', 'clear', false, function(event) {
  removeObject('Block.001');
  removeObject('Block2');
  removeObject('Block3.001');
});
